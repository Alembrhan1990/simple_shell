...
![image](https://user-images.githubusercontent.com/42976288/183352247-a00d20a7-1bba-404c-9099-89fbb34215e7.png)
 ...
 * Clone the current repository with the command: ```git clone "https://github.com/Alembrhan1990/simple_shell.git"```
